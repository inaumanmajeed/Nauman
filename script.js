...
class Birthday {
    constructor() {
        ...
        this.countdownDate = new Date('2025-02-28T00:00:00').getTime()
    }
    ...
    updateCountdown() {
        ...
        this.countdownPalette.innerHTML = `
            <div class="countdown-item">${days}<span>days</span></div>
            <div class="separator">:</div>
            <div class="countdown-item">${hours}<span>hours</span></div>
            <div class="separator">:</div>
            <div class="countdown-item">${minutes}<span>mins</span></div>
            <div class="separator">:</div>
            <div class="countdown-item">${seconds}<span>secs</span></div>
        `;
    ...
    showBirthdayWish() {
        ...
        this.birthdayWishContainer.classList.remove('hidden');
    }
